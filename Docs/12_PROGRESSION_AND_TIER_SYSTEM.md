...
3. **Region/climate readability** — if fixed regions and their climate states are not understood, migration pressure fails from the *environment* side of the same loop; treat climate clarity as same-class identity issue, parallel priority after Stage 1.  
