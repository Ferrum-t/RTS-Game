...
## M10 — construction site state. Scene-placed buildings stay constructed.
...
## M10 — start as construction site (player placement).
...
## Returns true when construction reaches 100%.
